...
5. Close the PowerShell installation window

6. On **LON-CL1**, start the PowerShell 7 command prompt.
...
7. Check your version of PowerShell by using `$PSVersionTable.PSVersion`.
...
8. From the PowerShell Gallery, install the Az module for the current user by using the **Install-Module** command.
